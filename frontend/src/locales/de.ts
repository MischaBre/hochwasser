const de = {
  ...
  jobForm: {
    ...
    fields: {
      ...
      alertRecipient: 'Alarm-Empfänger',
      alertRecipientPlaceholder: 'alarme@beispiel.de',
      recipients: 'Empfänger (durch Komma oder Zeilenumbruch getrennt)',
      ...
      scheduleCron: 'Zeitplan Cron (5 Felder)',
      scheduleCronPlaceholder: '*/15 * * * *',
      scheduleCronHint: 'Cron-Format: Minute Stunde Tag Monat Wochentag.',
  ...
  validation: {
    ...
    alertRecipientRequired: 'Alarm-Empfänger ist erforderlich.',
    alertRecipientTooLong: 'Alarm-Empfänger darf höchstens 254 Zeichen haben.',
    alertRecipientInvalid: 'Alarm-Empfänger muss eine gültige E-Mail-Adresse sein.',
    ...
    scheduleInvalid: 'Zeitplan muss ein gültiger Crontab-Ausdruck mit 5 Feldern sein.',
